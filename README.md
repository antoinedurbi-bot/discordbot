...
| `*embed` | `*em` | Éditeur interactif (aperçu en direct + boutons) : titre, texte, couleur, image, miniature, auteur, footer, champs personnalisés. Bouton "Envoyer en image" pour un rendu PNG dont le texte n'est pas copiable |
